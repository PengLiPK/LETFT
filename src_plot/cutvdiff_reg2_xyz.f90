...
character(len=70) :: nodefile,mdresf
character(len=70) :: tpfile



open(21,file='cutvdiff_reg2_xyz.inp',status='old')
read(21,*)outf
read(21,*)nodefile
...
do iz=1,znum
    do iy=1,ynum
        do ix=1,xnum
           ...
           y=miny+dble(iy-1)*dy 
           z=minz+dble(iz-1)*dz
           call ear2loc(xx,yy,zz,x,y,0d0,minx,miny,0d0)
