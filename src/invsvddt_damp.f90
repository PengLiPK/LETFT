program invsvddt_damp


implicit none
integer,parameter :: mmax=50000,nmax=6000,nb=64
...
open(31,file='invsvddt_damp.inp',status='old')
read(31,*)dfile
read(31,*)metagf
read(31,*)gfile
read(31,*)outf
