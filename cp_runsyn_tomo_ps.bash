...
######################################################
initvel_file_p=synvelp_init.txt
data_file_p=syndata_p_init.txt
initvel_file_s=synvels_init.txt
data_file_s=syndata_s_init.txt
#######################################################
...
cp ./$wkdir/syn_outf/$initvel_file_p ./$wkdir/syn_tomo/
cp ./$wkdir/syn_outf/$data_file_p ./$wkdir/syn_tomo/
cp ./$wkdir/syn_outf/$initvel_file_s ./$wkdir/syn_tomo/
cp ./$wkdir/syn_outf/$data_file_s ./$wkdir/syn_tomo/
...
cp vel_p.txt ../syn_outf/vel_p_final.txt
cp vel_s.txt ../syn_outf/vel_s_final.txt
cp syndataloc_p.txt ../syn_outf/syndata_p_out.txt
cp syndataloc_s.txt ../syn_outf/syndata_s_out.txt
