...
interface
    subroutine cacut(isr,source,receiver,evnum,node,nnode,nr,nl,layer,&
...
! Read parameters.
!-----------------------------------------------------------------------
open(21,file='fmm_fw_regul2.inp',status='old')
read(21,*)datafile
read(21,*)nodefile
read(21,*)ns
read(21,*)dx,dy,dz
...
do is=1,ns
    ...
    call cacut(is,source(is),preceiver,pevnum,node,nnode,&
...
do ig=1,rttlgnum
    ...
    rs(ig)=trilinear(node(n(1))%t,node(n(2))%t,&
                    ...
                    &rtravelt(ig)%x,rtravelt(ig)%y,rtravelt(ig)%z,1)
...
ssr=trilinear(node(n(1))%t,node(n(2))%t,&
             &node(n(3))%t,node(n(4))%t,&
             &node(n(5))%t,node(n(6))%t,&
             &node(n(7))%t,node(n(8))%t,&
             &node(n(1))%x,node(n(1))%y,node(n(1))%z,&
...
do ig=1,ttlgnum
    ...
    s(ig)=trilinear(node(n(1))%t,node(n(2))%t,&
                   &node(n(3))%t,node(n(4))%t,&
                   &node(n(5))%t,node(n(6))%t,&
                   &node(n(7))%t,node(n(8))%t,&
                   &node(n(1))%x,node(n(1))%y,node(n(1))%z,&
                   &node(n(8))%x,node(n(8))%y,node(n(8))%z,&
                   &travelt(ig)%x,travelt(ig)%y,travelt(ig)%z,1)
