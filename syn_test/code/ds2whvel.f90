...
open(21,file='ds2whvel.inp',status='old')
read(21,*)outf
read(21,*)outpf
read(21,*)outvpf
read(21,*)inpf
...
write(30,*)xnum*ynum*znum
write(35,*)xnum*ynum*znum
write(40,*)xnum*ynum*znum
do iz=1,znum
    do iy=1,ynum
        do ix=1,xnum
           x=minx+dble(ix-1)*dx
           ...
           if(z .gt. topozbtm)then
              ...
              !            &x,y,z,0)
               ...
               sper=trilinear(dsg(n(1)),dsg(n(2)),dsg(n(3)),dsg(n(4)),&
                          ...
                          &node(n(8))%x,node(n(8))%y,node(n(8))%z,&
                          &x,y,z,0)
               call vfrom1d(vtemp,z,vinp,nlayer)
               v=vtemp*(1d0+vper)
               write(30,*)x,y,z,v
               write(35,*)x,y,z,sper
               write(40,*)x,y,z,vper
               ...
               if(updown .eq. -1)then
                   ...
                   !v=trilinear(vg(n(1)),vg(n(2)),vg(n(3)),vg(n(4)),&
                   !           &vg(n(5)),vg(n(6)),vg((7)),vg(n(8)),&
                   !           &node(n(1))%x,node(n(1))%y,node(n(1))%z,&
                   !           &node(n(8))%x,node(n(8))%y,node(n(8))%z,&
                   !           &x,y,z,0)
                   vper=trilinear(dvg(n(1)),dvg(n(2)),dvg(n(3)),dvg(n(4)),&
                              &dvg(n(5)),dvg(n(6)),dvg((7)),dvg(n(8)),&
                              &node(n(1))%x,node(n(1))%y,node(n(1))%z,&
                              &node(n(8))%x,node(n(8))%y,node(n(8))%z,&
                              &x,y,z,0)
                   sper=trilinear(dsg(n(1)),dsg(n(2)),dsg(n(3)),dsg(n(4)),&
                              &dsg(n(5)),dsg(n(6)),dsg((7)),dsg(n(8)),&
                              &node(n(1))%x,node(n(1))%y,node(n(1))%z,&
                              &node(n(8))%x,node(n(8))%y,node(n(8))%z,&
                              &x,y,z,0)
                   call vfrom1d(vtemp,z,vinp,nlayer)
