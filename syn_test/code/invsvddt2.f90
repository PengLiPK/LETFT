...
real(kind=8) :: d(mmax),tmp1(mmax),m(nmax)
...
open(31,file='invsvddt2.inp',status='old')
read(31,*)dfile
read(31,*)metagf
read(31,*)gfile
read(31,*)outf
...
call dgesdd('All',idmax,imtmax,g,lda,s,u,ldu,vt,&
...
! Calculate model
tmp1(1:idmax)=matmul(transpose(u(1:idmax,1:idmax)),&
                    &d(1:idmax))
