...
velfile4=out_svd_n19.4vdiff.txt
rctf=dws_n19.4.txt
...
gmt makecpt -T-1/1/0.01 -D -I -Cwysiwyg > $velfile4.cpt
...
gmt psscale -D5c/-1c/6c/0.5ch -O -K -C$velfile4.cpt -B0.4:"dV \(km\/s\)": >> $velfile4.ps
