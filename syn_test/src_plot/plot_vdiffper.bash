...
velfile4=out_svd_n19.4vdiffper.txt
rctf=dws_n19.4.txt
...
gmt makecpt -T-0.12/0.12/0.001 -D -I -Cwysiwyg > $velfile4.cpt
...
gmt grdcontour $resf.grd -J -R -C0.3 -W2p,gray -S4 -O -K >> $velfile4.ps
awk '{print $1-360,4.079-$3}' elev_line.txt | gmt psxy -J -R -W2p -O -K >>$velfile4.ps
gmt psscale -D5c/-1c/6c/0.5ch -O -K -C$velfile4.cpt -B0.03:"dV\/V": >> $velfile4.ps
